        ...
        <div
            ...
            <div class="mb-8 flex flex-col xl:flex-row xl:items-center justify-between gap-6">
                ...
                <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                    ...
                    <form action="{{ route('admin.analytics') }}" method="GET" class="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center w-full sm:w-auto">
                        @if(request('role'))
                            <input type="hidden" name="role" value="{{ request('role') }}">
                        @endif
                        <div class="relative flex-1 sm:flex-none">
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Search entities..."
                                ...
                                <td class="px-6 py-6 text-right whitespace-nowrap">
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-[9px] font-black text-emerald-500/80 uppercase tracking-tighter">
                                            {{ number_format($reseller->completed_orders_count) }} Solved
                                        </p>
                                    </div>
                                </td>
                                <td class="px-6 py-6 text-right whitespace-nowrap">
