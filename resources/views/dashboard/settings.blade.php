                    ...
                    <form action="{{ route('settings.update') }}" method="POST" id="notifications-form" class="space-y-10">
                        ...
                        <div class="space-y-8">
                            <div class="flex items-center justify-between group">
                                ...
                                <input type="checkbox" name="notification_email" id="notification_email" value="1" {{ $user->notification_email ? 'checked' : '' }} class="hidden">
                            </div>
                            ...
                            <div class="flex items-center justify-between group">
                                ...
                                <input type="checkbox" name="notification_sms" id="notification_sms" value="1" {{ $user->notification_sms ? 'checked' : '' }} class="hidden">
                            </div>
                        </div>
                    </form>
                </div>
