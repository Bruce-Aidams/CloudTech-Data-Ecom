...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <?php if($filteredUser): ?>
                <div
                    ...
                    <div>
                        ...
                        <p class="text-sm font-black text-slate-900 dark:text-white mt-1"><?php echo e($filteredUser->name); ?>'s History</p>
                    </div>
        ...
        <?php if(request('reseller_id')): ?>
            <?php $filteredReseller = \App\Models\User::find(request('reseller_id')); ?>
            <?php if($filteredReseller): ?>
                <div
                    ...
                    <div>
                        ...
                        <p class="text-sm font-black text-slate-900 dark:text-white mt-1"><?php echo e($filteredReseller->name); ?>'s Customers
                        </p>
                    </div>
                    <a href="<?php echo e(route('admin.orders')); ?>"
                        class="ml-2 p-1.5 hover:bg-rose-50 dark:hover:bg-rose-900/20 text-slate-400 hover:text-rose-600 rounded-lg transition-all"
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex gap-2 p-1 bg-slate-100 dark:bg-slate-800/50 rounded-xl w-fit overflow-x-auto scrollbar-hide">
                ...
                <?php $__currentLoopData = ['all', 'awaiting_transfer', 'pending', 'processing', 'completed', 'failed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button onclick="filterBy('status', '<?php echo e($s); ?>')"
                        class="px-4 py-2 rounded-lg text-xs font-bold capitalize transition-all whitespace-nowrap
                                                                                                                                                                                                                                                                                            <?php echo e(request('status', 'all') == $s ? 'bg-white dark:bg-slate-900 text-slate-900 dark:text-white shadow-sm' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'); ?>">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    <div class="relative min-w-[140px]">
                        <select onchange="filterBy('per_page', this.value)"
                            ...
                            <?php $__currentLoopData = [10, 15, 40, 100, 500]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div
                        ...
                        <button onclick="filterBy('network', 'all')"
                            class="px-4 py-2 rounded-lg text-xs font-bold capitalize transition-all whitespace-nowrap <?php echo e(request('network', 'all') == 'all' ? 'bg-white dark:bg-slate-900 text-slate-900 dark:text-white shadow-sm' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'); ?>">
                            All Networks
                        </button>
                        <?php $__currentLoopData = $networks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $network): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button onclick="filterBy('network', '<?php echo e($network); ?>')"
                                class="px-4 py-2 rounded-lg text-xs font-bold uppercase transition-all whitespace-nowrap <?php echo e(request('network') == $network ? 'bg-white dark:bg-slate-900 text-slate-900 dark:text-white shadow-sm' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'); ?>">
                                <?php echo e($network); ?>
                ...
                <div class="flex items-center gap-4">
                    <div class="text-[10px] font-bold text-slate-400 uppercase tracking-widest hidden lg:block">
                        Showing <?php echo e($orders->firstItem() ?? 0); ?>-<?php echo e($orders->lastItem() ?? 0); ?> of <?php echo e($orders->total()); ?>

                    </div>
                    <div class="admin-pagination-top">
                        <?php echo e($orders->links('pagination::simple-tailwind')); ?>
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div
                                                ...
                                                <?php if($order->source === 'storefront' && $order->guest_email): ?>
                                                    <?php echo e(strtoupper(substr($order->guest_email, 0, 1))); ?>
        ...
        <?php if($orders->isNotEmpty()): ?>
            <div
                ...
                <div class="text-xs font-bold text-slate-500 dark:text-slate-500 uppercase tracking-widest italic">
                    Records: <?php echo e($orders->firstItem()); ?>-<?php echo e($orders->lastItem()); ?> of <?php echo e($orders->total()); ?>
