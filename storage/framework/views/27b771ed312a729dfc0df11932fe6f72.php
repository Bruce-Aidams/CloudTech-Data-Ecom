    ...
    <div class="max-w-7xl mx-auto px-4 py-12 md:py-20 space-y-16">
        ...
        <div class="text-center space-y-6">
            ...
            <h1
                ...
                <?php echo e($reseller->name); ?>'s <span class="text-primary">Data Hub</span>
            </h1>
            <p
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="absolute top-4 left-4">
                            ...
                            ?>
                            <span
                                class="px-3 py-1.5 rounded-xl text-[10px] font-black tracking-widest uppercase shadow-xl backdrop-blur-md <?php echo e($nc); ?>">
                    ...
                    <div class="p-8 space-y-6">
                        <div>
                            ...
                            <p class="text-xs font-bold text-slate-400 mt-1 uppercase tracking-widest">
                                <?php echo e($bundle->data_amount); ?> Data Allocation</p>
                        </div>
                        ...
                        <div class="pt-6 border-t border-slate-50 dark:border-slate-800 flex items-center justify-between">
                            ...
                            <a href="<?php echo e(url('/login?redirect=purchase&bundle=' . $bundle->id . '&ref=' . $reseller->referral_code)); ?>"
        ...
        <div class="pt-20 border-t border-slate-100 dark:border-slate-800 text-center space-y-4">
            ...
            <p class="text-xs text-slate-500 dark:text-slate-500 font-bold uppercase tracking-widest">Powered by
                <?php echo e(config('app.name')); ?> Integration Engine</p>
        </div>
    </div>
</body>

</html><?php /**PATH C:\Users\Bruce\Desktop\Projects\Megaai2\Megaai\cloudtech\resources\views/reseller/store/index.blade.php ENDPATH**/ ?>