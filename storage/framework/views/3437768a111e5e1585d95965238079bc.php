                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <h3 class="text-xl md:text-3xl font-black text-slate-800 dark:text-white mt-1 tabular-nums">
                            ₵<?php echo e(number_format($balance, 2)); ?></h3>
                    </div>
                    <div
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr
                                ...
                                <td class="flex justify-between items-center px-6 py-4 md:table-cell md:px-8">
                                    ...
                                    <span
                                        class="font-mono text-[10px] font-black text-primary tracking-tighter uppercase">#<?php echo e(strtoupper(substr($order->reference, 0, 8))); ?></span>
                                </td>
                                ...
                                <td class="flex justify-between items-center px-6 py-4 md:table-cell md:px-6">
                                    ...
                                    <span
                                        class="font-mono text-[11px] text-slate-400 font-bold"><?php echo e($order->recipient_phone); ?></span>
                                </td>
                                <td class="flex justify-between items-center px-6 py-4 md:table-cell md:px-6">
                                    <span
                                        class="md:hidden text-[10px] font-bold text-slate-400 uppercase tracking-widest">Price</span>
                                    <span
                                        class="text-xs font-black text-slate-900 dark:text-white">₵<?php echo e(number_format($order->cost, 2)); ?></span>
                                </td>
                                <td class="flex justify-between items-center px-6 py-4 md:table-cell text-right md:px-8">
                                    ...
                                    ?>
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-widest <?php echo e($sc); ?>"><?php echo e($label); ?></span>
                                </td>
                            </tr>
