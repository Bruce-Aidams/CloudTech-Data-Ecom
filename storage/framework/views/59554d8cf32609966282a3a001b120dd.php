            ...
            <div class="flex gap-4">
                <div class="px-4 py-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm">
                 ...
                 <div class="px-4 py-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm">
                    ...
                    <p class="text-lg font-black text-emerald-500">₵<?php echo e(number_format($stats['total_commission_paid'], 2)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm">
            <form method="GET" class="flex gap-4">
                <div class="flex-1 relative">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search by name, email, phone or code..." 
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $resellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reseller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                ...
                                <td class="px-6 py-4 font-mono font-bold text-slate-900 dark:text-white">
                                    ₵<?php echo e(number_format($reseller->wallet_balance, 2)); ?>

                                </td>
                                <td class="px-6 py-4 font-mono font-bold text-emerald-500">
                                    ₵<?php echo e(number_format($reseller->commission_balance, 2)); ?>

                                </td>
                                <td class="px-6 py-4">
                                    <?php if($reseller->referral_code): ?>
                                        <a href="<?php echo e(route('store.show', $reseller->referral_code)); ?>" target="_blank" class="text-xs text-primary hover:underline flex items-center gap-1">
                                            Visit Store
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div x-data="{ open: false }" class="relative inline-block text-left">
                                        ...
                                        <div x-show="open" class="absolute right-0 mt-2 w-48 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-100 dark:border-slate-800 z-50 overflow-hidden" x-cloak>
                                            <div class="py-1">
                                                <button onclick="openCommissionModal(<?php echo e($reseller->id); ?>, '<?php echo e($reseller->name); ?>')" class="w-full text-left px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800">
                                                    Adjust Commission
                                                </button>
                                                ...
                                                <a href="<?php echo e(route('admin.users')); ?>?search=<?php echo e($reseller->email); ?>" class="block w-full text-left px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800">
                                                    Manage User
                                                </a>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bruce\Desktop\Projects\Megaai2\Megaai\cloudtech\resources\views/admin/resellers/index.blade.php ENDPATH**/ ?>