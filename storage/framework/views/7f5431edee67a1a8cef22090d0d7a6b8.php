                    ...
                    <tbody class="divide-y divide-slate-50 dark:divide-slate-800">
                        <?php $__empty_1 = true; $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors group">
                                <td class="px-6 py-4">
                                    <span
                                        class="font-bold text-sm text-slate-900 dark:text-white block"><?php echo e($d->created_at->format('d M, Y')); ?></span>
                                    <span
                                        class="text-[10px] text-slate-500 dark:text-slate-500 mt-1 uppercase"><?php echo e($d->created_at->format('h:i A')); ?></span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[10px] text-slate-500 dark:text-slate-500 mt-1"><?php echo e($d->user->email); ?>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <p class="text-sm font-bold text-slate-900 dark:text-white">GHC
                                        <?php echo e(number_format($d->amount, 2)); ?>
            ...
            <?php if($deposits->isNotEmpty()): ?>
                <div
                    ...
                    <div class="text-xs font-bold text-slate-500 dark:text-slate-500 uppercase tracking-widest italic">Ledger
                        Entries: <?php echo e($deposits->total()); ?></div>
