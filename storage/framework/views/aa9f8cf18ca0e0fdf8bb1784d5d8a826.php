                ...
                <div class="space-y-1 max-h-[350px] overflow-y-auto custom-scrollbar">
                    <?php $__empty_1 = true; $__currentLoopData = $unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="p-4 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-all group/item cursor-pointer"
                            onclick="markNotificationAsRead(<?php echo e($notification->id); ?>, this)">
...
</script><?php /**PATH C:\Users\Bruce\Desktop\Projects\Megaai2\Megaai\cloudtech\resources\views/components/dashboard-header.blade.php ENDPATH**/ ?>