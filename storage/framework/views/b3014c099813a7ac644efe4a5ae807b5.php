...
<?php $__env->startSection('content'); ?>
    <div class="max-w-5xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
        ...
        <div>
            <h2 class="text-3xl font-black tracking-tight text-slate-900 dark:text-white uppercase">Account Settings</h2>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Update your password and manage your notification
                preferences.
            </p>
        </div>
        ...
        <div class="grid gap-12">
            ...
            <div
                ...
                <h3 class="text-[10px] font-black uppercase tracking-[.3em] text-slate-400 dark:text-slate-600 mb-10">Change
                    Password</h3>

                <form action="<?php echo e(route('settings.update')); ?>" method="POST" class="space-y-10">
                    <?php echo csrf_field(); ?>
            ...
            <div class="grid gap-12 md:grid-cols-2">
                ...
                <div
                    ...
                    <form action="<?php echo e(route('settings.update')); ?>" method="POST" id="notifications-form" class="space-y-10">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="space-y-8">
                            <div class="flex items-center justify-between group">
                                ...
                                <button type="button" role="switch"
                                    aria-checked="<?php echo e($user->notification_email ? 'true' : 'false'); ?>"
                                    ...
                                    class="<?php echo e($user->notification_email ? 'bg-primary' : 'bg-slate-100 dark:bg-slate-800'); ?> inline-flex h-7 w-14 items-center rounded-full border-2 border-transparent transition-all">
                                    <span
                                        class="<?php echo e($user->notification_email ? 'translate-x-7' : 'translate-x-0'); ?> block h-5 w-5 rounded-full bg-white shadow-xl transition-transform"></span>
                                </button>
                                <input type="checkbox" name="notification_email" id="notification_email" value="1" <?php echo e($user->notification_email ? 'checked' : ''); ?> class="hidden">
                            </div>
                            ...
                            <div class="flex items-center justify-between group">
                                ...
                                <button type="button" role="switch"
                                    aria-checked="<?php echo e($user->notification_sms ? 'true' : 'false'); ?>"
                                    ...
                                    class="<?php echo e($user->notification_sms ? 'bg-primary' : 'bg-slate-100 dark:bg-slate-800'); ?> inline-flex h-7 w-14 items-center rounded-full border-2 border-transparent transition-all">
                                    <span
                                        class="<?php echo e($user->notification_sms ? 'translate-x-7' : 'translate-x-0'); ?> block h-5 w-5 rounded-full bg-white shadow-xl transition-transform"></span>
                                </button>
                                <input type="checkbox" name="notification_sms" id="notification_sms" value="1" <?php echo e($user->notification_sms ? 'checked' : ''); ?> class="hidden">
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-[10px] font-black uppercase tracking-[.3em] text-slate-400 dark:text-slate-600 mb-10">UI
                        Environment</h3>
                    ...
                    <div class="space-y-8">
                        <div class="flex items-center justify-between group">
                            <div class="space-y-1">
                                ...
                                <p class="text-[9px] font-bold uppercase tracking-widest text-slate-400">Toggle dark theme
                                </p>
                            </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-8">
                    <div class="space-y-2 text-center sm:text-left">
                        ...
                        <p
                            ...
                            Warning: This will permanently delete your account and all associated data. This action cannot
                            be reversed.</p>
                    </div>
                    <form
                        onsubmit="return confirm('Are you sure you want to delete your account? This action cannot be reversed.');"
                        action="<?php echo e(route('settings.destroy')); ?>" method="POST">
                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                        <button type="submit"
                            class="h-14 px-10 rounded-2xl bg-rose-600 text-[10px] font-black uppercase tracking-widest text-white shadow-lg shadow-rose-500/10 hover:bg-rose-700 active:scale-95 transition-all">
                            Delete Account
                        </button>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bruce\Desktop\Projects\Megaai2\Megaai\cloudtech\resources\views/dashboard/settings.blade.php ENDPATH**/ ?>