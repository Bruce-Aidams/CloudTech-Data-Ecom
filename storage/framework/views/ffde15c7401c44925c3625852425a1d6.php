        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-200"
                ...
                <div class="flex items-center justify-between mb-4 px-2">
                    ...
                    <?php if($unreadCount > 0): ?>
                        <span class="text-[10px] font-bold text-primary"><?php echo e($unreadCount); ?> New</span>
                    <?php endif; ?>
                </div>
                        ...
                        <div
                            ...
                            <div
                                class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 
                                    <?php echo e($notification->type === 'success' ? 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-500' : 'bg-blue-50 dark:bg-blue-900/20 text-blue-500'); ?>">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-xs font-semibold text-slate-900 dark:text-slate-100 truncate">
                                    <?php echo e($notification->title); ?></p>
...
</header><?php /**PATH C:\Users\Bruce\Desktop\Projects\Megaai2\Megaai\cloudtech\resources\views/components/admin-navbar.blade.php ENDPATH**/ ?>